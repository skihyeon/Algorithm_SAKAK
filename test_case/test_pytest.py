import pytest
from logics.functions import generate_next_term_from_current_term, get_nth_term, main
...
def test_main_n_zero_or_negative():
    with pytest.raises(ValueError, match=r"n은 양의 정수여야 합니다."):
        main(0)
    with pytest.raises(ValueError, match=r"n은 양의 정수여야 합니다."):
        main(-1)
